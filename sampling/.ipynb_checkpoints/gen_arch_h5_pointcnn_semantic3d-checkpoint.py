...
def main():
    ...
    parser.add_argument('--block_size', '-b', help='Block size', type=float, default=2.5)
    parser.add_argument('--grid_size', '-g', help='Grid size', type=float, default=0.05)
        ...
        for dataset_idx, dataset in enumerate(datasets):
            ...
            for offset_name, offset in offsets:
                ...
                for block_idx in range(idx_last_non_empty_block + 1):
                    ...
                    block_xzyrgbnormal = np.concatenate([xyz[point_indices], x, z, y, rgb[point_indices], normal[point_indices]], axis=-1)
                    ...
                    for block_split_idx in range(block_split_num):
                        ...
                        if ((idx + 1) % batch_size == 0) or \
                            ...
                            filename_h5 = os.path.join(output_dir, folder.split('/')[-1], dataset[:-4] + '_%d_%s_%d.h5' % (max_point_num, offset_name, idx_h5))
